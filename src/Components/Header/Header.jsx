                    ...
                    <div class="hidden md:block">
                        <nav aria-label="Global">
                            <ul class="flex items-center gap-6 text-sm">
                                ...
                                <li>
                                    <a class="text-gray-500 transition hover:text-gray-500/75" href="#"> Featured </a>
                                </li>

                                <li>
                                    <a class="text-gray-500 transition hover:text-gray-500/75" href="#"> Details </a>
                                </li>
                                ...
                                <li>
                                    <a class="text-gray-500 transition hover:text-gray-500/75" href="#"> FAQs </a>
                                </li>
                            </ul>
                        </nav>
                    </div>
